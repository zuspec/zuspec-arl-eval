...
class ValOpsDataTypeAddrSpaceC : public virtual vsc::dm::IValOps {
public:
    ValOpsDataTypeAddrSpaceC(IEvalContext *ctxt);

    virtual ~ValOpsDataTypeAddrSpaceC();
